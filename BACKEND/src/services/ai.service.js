...
const geminiModel = new ChatGoogleGenerativeAI({
    ...
    // Add these for extra control over token usage
    maxOutputTokens: 100, // Keep this low if you only need short answers
    temperature: 0.2     // Lower temperature is usually faster and more consistent
});
